...
widgets.saved_widgets.scroll_texts = widgets.saved_widgets.scroll_texts or {}
...
function scrolling_text.new(settings)
    ...
    table.insert(widgets.saved_widgets.scroll_texts, t)
...
function scrolling_text.hover(t, x, y)
    return t.bg:hover(x, y) or t.bar:hover(x, y)
end
...
function scrolling_text.get_events(t)
